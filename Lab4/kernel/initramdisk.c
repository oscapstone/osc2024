...
void initramdisk_main(uintptr_t cpio_addr) {
    ...
    cpio = (char *)cpio_addr;
    uart_send_string("cpio start address: ");
    uart_send_uint((uintptr_t)cpio);
    uart_send_string("\r\n");
    ...
    // uart_send_string("Print root directory: ");
    // uart_send_string(rootDir->dName);
    // uart_send_string("\r\n");
    ...
    // if (rootDir.dHeader.mode & 040000)
...
struct CpioHeader* parse_cpio_header() {
    // uart_send_string("In parse cpio header\r\n");
    ...
    // uart_send_uint(header->nameSize);
    // uart_send_string("\r\n");
