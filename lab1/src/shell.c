...
{
    // print hw revision
    pt[0] = 8 * 4; // buffer size in bytes
    pt[1] = MBOX_REQUEST_PROCESS;
    // tags begin
    pt[2] = MBOX_TAG_GET_BOARD_REVISION; // tag identifier
    pt[3] = 4; // maximum of request and response value buffer's length
