...
info_board_revision()
{
    volatile unsigned int *mbox = mailbox;
    ...
    mailbox_call(MBOX_CH_PROP, mbox);                     // message passing procedure call
...
info_videocore()
{
    ...
    mailbox_call(MBOX_CH_PROP, mbox); // message passing procedure call, you should implement it following the 6 steps provided above.
