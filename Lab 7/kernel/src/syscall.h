...
int32_t     syscall_open(const char *pathname, int flags);
int32_t     syscall_close(int fd);
int64_t     syscall_write(int fd, const void *buf, unsigned long count);  
int64_t     syscall_read(int fd, void *buf, unsigned long count);
int32_t     syscall_mkdir(const char *pathname, unsigned mode);
int32_t     syscall_mount(const char *src, const char *target, const char *filesystem, uint64_t flags, const void *data);
