...
// #define CPIO_for_each(header_ptr, c_filepath, c_filesize, c_filedata, next_header_ptr)                         \
//     do                                                                                                         \
//     {                                                                                                          \
//         while (1)                                                                                              \
//         {                                                                                                      \
//             int err = cpio_newc_parse_header(header_ptr, c_filepath, c_filesize, c_filedata, next_header_ptr); \
//             if (err)                                                                                           \
//             {                                                                                                  \
//                 break;                                                                                         \
//             }                                                                                                  \
...
#define CPIO_for_each(c_filepath, c_filesize, c_filedata)                                          \
    struct cpio_newc_header *header_ptr = CPIO_DEFAULT_START;                                      \
    int err = cpio_newc_parse_header(header_ptr, c_filepath, c_filesize, c_filedata, &header_ptr); \
    for (; header_ptr&&!err; cpio_newc_parse_header(header_ptr, c_filepath, c_filesize, c_filedata, &header_ptr))
