...
#define CORE0_TIMER_IRQ_CTRL	((volatile unsigned int*)(0x40000040 + 0xffff000000000000))
#define CORE0_INTERRUPT_SOURCE	((volatile unsigned int*)(0x40000060 + 0xffff000000000000))
