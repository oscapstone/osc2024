...
void frames_init(){
    ...
    memory_start = 0x000 + 0xffff000000000000;
    memory_end = 0x3C000000 + 0xffff000000000000;
    split_line();
    ...
    memory_reserve(0x0000 + 0xffff000000000000, base); //to save the stack from being allocated
