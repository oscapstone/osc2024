...
void handle_command(char* cmd) {
    ...
    switch(cmd_list_ind) {
        ...
        case 9:
            ...
            // int time = str2Int(arg[1], strlen(arg[1]));
            // if (arg[2][0] == '0') {
            //     uart_send_string("Add exit loop\r\n");
            //     add_timer(exit_loop, (void *)arg[0], time);
            // } else if (arg[2][0] == '1') {
            //     uart_send_string("Add create loop\r\n");
            //     add_timer(create_loop, (void *)arg[0], time);
            // }
        ...
        case 15:
            if (arg_cnt > 1) {
                uart_send_string("  dalloc: too many arguments\r\n");
                break;
            } else if (arg_cnt < 1) {
                uart_send_string("  dalloc: not enough arguments\r\n");
                break;
            }
        ...
        case 17:
            if (arg_cnt > 2) {
                ...
                uart_send_string("  rsv_mem: not enough arguments\r\n");
                break;
            }
        ...
        case 18:
            if (arg_cnt > 0) {
                uart_send_string("  multithreading: too many arguments\r\n");
                break;
            }

            thread_t* t1 = thread_create(foo);
            thread_t* t2 = thread_create(foo);
            thread_t* t3 = thread_create(foo);
        ...
        case 19:
            if (arg_cnt > 0) {
                uart_send_string("  getpid: too many arguments\r\n");
                break;
            }
