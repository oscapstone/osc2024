...
typedef struct cpio_newc_header {
    char c_magic[6];    // The integer value octal 070701. Determine whether this archive is written with little-endian or big-endian integers.
    char c_ino[8];      // The  device and inode numbers from the disk. Used to determine when two entries refer to	the same file.
