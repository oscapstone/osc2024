...
#define MEMORY_SIZE 1024 // Adjust this size as needed
static char memory[MEMORY_SIZE]; // Pre-allocated memory block
static size_t offset = 0; // Current offset in the memory block
