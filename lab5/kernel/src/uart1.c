...
int uart_recv_echo_flag = 1; // to prevent the syscall.img from using uart_send() in uart_recv()
...
void uart_init()
{
    ...
    *AUX_MU_IER_REG   = 0xC6;    // enable FIFO      0xc6 = 0b1100 0000
...
// AUX_MU_IIR_REG -> BCM2837-ARM-Peripherals.pdf - Pg.12
