...
void get_board_revision(){
    ...
    miniUARTWriteString("board revision : ");
    miniUARTWriteHex(mailbox[5]);
    miniUARTWriteString("\r\n");
}
...
void get_memory_info() {
    ...
    miniUARTWriteString("ARM memory base address : ");
    miniUARTWriteHex(mailbox[5]);
    miniUARTWriteString("\r\n");

    miniUARTWriteString("ARM memory size : ");
    miniUARTWriteHex(mailbox[6]);
    miniUARTWriteString("\r");
